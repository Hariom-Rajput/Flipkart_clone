...
const CartItem = ({ item, removeItemFromCart }) => {
    ...
    return (
        <Card className={classes.component}>
            ...
            {/* image of product which is left side */}
...
{/* all description about the product whuich left side of the image of product */}
            <Box className={classes.mid}>
                ...
                <Button className={classes.remove}>Save for Later</Button>
