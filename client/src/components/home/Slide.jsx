...
// respose on the different divices screen  
const responsive = {
    desktop: {
...
const useStyle = makeStyles(theme => ({
    ...
    timerr: {
        [theme.breakpoints.down('sm')]: {
            display: 'none'                     //  when screen would be small then remove the timer
        }
    }
}));
...
const MultiSlide = ({ data, timer, title }) => {
    ...
    const renderer = ({ hours, minutes, seconds }) => {
        return <span className={classes.timerr}>{hours} : {minutes} : {seconds}  Left</span>;
    };
    ...
    return (
        <Box className={classes.component}>
            ...
            <Carousel
                ...
                // removeArrowOnDeviceType={["tablet", "mobile"]}           //  arrow on the slide would not be display when screen is small
